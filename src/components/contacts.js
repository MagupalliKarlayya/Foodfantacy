      ...
      <div className="sm:p-10 my-auto">
        <section className="mx-auto max-w-screen-xl md:rounded-md md:border md:shadow-lg">
          <div className="grid grid-cols-4 text-gray-800 lg:grid-cols-3">
            ...
            <div className="order-first bg-white col-span-4 max-w-screen-md px-8 py-10 md:order-last md:col-span-2 md:px-10 md:py-12">
              ...
              <form onSubmit={handleMessage}>
                ...
                <button
                  src="/"
                  type="submit"
                  className="group flex cursor-pointer items-center rounded-xl bg-green-500 bg-none px-8 py-4 text-center font-semibold leading-tight text-white"
                >
                  Send
                  <svg
        ...
        {Message && (
          <span className=" flex m-5 ml-[250px] text-wrap text-xl font-semibold text-gray-5000">
            Thanks for contacting Foodfantacy, We will reply ASAP.{" "}
          </span>
        )}
      </div>
    </div>
